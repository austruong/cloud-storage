...
os.system('gcc "Client Domain/client.c" -o "Client Domain/client" -lssl -lcrypto -lpthread')
os.system('gcc "Server Domain/server.c" -o "Server Domain/server" -lssl -lcrypto -lpthread')
